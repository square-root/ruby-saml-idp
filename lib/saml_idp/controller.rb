...
module SamlIdp
  module Controller
    ...
    def inclusive_name_spaces
      '<ds:InclusiveNamespaces xmlns="http://www.w3.org/2001/10/xml-exc-c14n#" PrefixList="#default samlp saml ds xs xsi" ></ds:InclusiveNamespaces>'
    end
